        ...
        <div className="container">
          ...
          <div className="beer-slider">
            <div className="beer-track">
              {[
                { src: '/medove2.jpg', title: 'Світле пиво', desc: "Освіжаюче світле пиво з м'яким смаком та легким ароматом" },
                { src: '/firmove6.png', title: 'Крафтове пиво', desc: 'Унікальні сорти крафтового пива з ексклюзивними рецептурами'},
                { src: '/pshen5.jpg', title: 'Пшеничне пиво', desc: 'Свіже пшеничне пиво з фруктовими нотами та м\'якою піною'},
                { src: '/dusha.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/koryf2.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/blanche2.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами'},
                { src: '/bile4.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/odeske2.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/porter2.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/zhig2.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
                { src: '/сeske_spec.jpg', title: 'Темне пиво', desc: 'Насичене темне пиво з багатим смаком та карамельними нотами' },
              ].map((item, idx) => (
